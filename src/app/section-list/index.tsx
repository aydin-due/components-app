    ...
    <ThemedView margin>
      <ThemedCard>
        <SectionList
          ...
          ListHeaderComponent={() => (<ThemedText type='h1' className='font-bold mb-3'>characters</ThemedText>)}
          renderSectionHeader={({ section }) => (<ThemedText type='h2' className='bg-light-background font-bold dark:bg-dark-background p-2 rounded'>{section.title}</ThemedText>)}
          stickySectionHeadersEnabled
          ListFooterComponent={() => (<ThemedText type="h2" className='font-bold mb-10 bg-light-background dark:bg-dark-background p-2 rounded'>sections: {houses.length}</ThemedText>)}
